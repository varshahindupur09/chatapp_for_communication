package com.chatbotapp.websockets;

import com.chatbotapp.redis.Publisher;
import com.chatbotapp.redis.Subscriber;
...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    // my request would look like: http://localhost:8080/user/abcdefgh
